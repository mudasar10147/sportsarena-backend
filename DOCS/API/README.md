...
Complete API endpoint documentation for the SportsArena backend.

## Core API Guides

- **API_ARCHITECTURE.md** - Overall API architecture and design
...
- **AVAILABILITY_API_GUIDE.md** - Availability and slot generation endpoints (rule-based system)
...
- **PROFILE_IMAGE_REPLACEMENT_GUIDE.md** - Profile image replacement
...
1. Read **API_ARCHITECTURE.md** for overall understanding
2. Check **API_ROUTES.md** for route overview
3. Refer to specific resource guides as needed
