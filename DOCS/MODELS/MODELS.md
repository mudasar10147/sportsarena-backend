...
> **📊 For complete database design, see:**
> - [Database ERD](../DATABASE_ERD.md) - Visual Entity Relationship Diagram
> - [Database Relationships](../DATABASE_RELATIONSHIPS.md) - Detailed relationships and constraints
...
| Facility | ✅ Complete | 2025-01-XX |
| Sport | ✅ Complete | 2025-01-XX |
| FacilitySport | ✅ Complete | 2025-01-XX |
| Court | ✅ Complete | 2025-01-XX |
| TimeSlot | ✅ Complete | 2025-01-XX |
| Booking | ✅ Complete | 2025-01-XX |
| PaymentTransaction | ✅ Complete | 2025-01-XX |
...
# Facility table
psql -d sportsarena -f src/db/migrations/002_create_facilities_table.sql

# Sport table (includes pre-seeded sports)
psql -d sportsarena -f src/db/migrations/003_create_sports_table.sql

# FacilitySport linking table
psql -d sportsarena -f src/db/migrations/004_create_facility_sports_table.sql

# Court table
psql -d sportsarena -f src/db/migrations/005_create_courts_table.sql

# TimeSlot table
psql -d sportsarena -f src/db/migrations/006_create_time_slots_table.sql

# Booking table
psql -d sportsarena -f src/db/migrations/007_create_bookings_table.sql

# PaymentTransaction table
psql -d sportsarena -f src/db/migrations/008_create_payment_transactions_table.sql
```

Or use the migration files directly in your database setup script.

**All MVP models are now complete! 🎉**
